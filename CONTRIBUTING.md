Contributing to ESCO Core
============================

The ESCO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ESCO Core project, and is not to be
confused with overall ESCO Network Protocol consensus changes.

Whether a pull request is merged into ESCO Core rests with the project merge
...
Patches that change ESCO consensus rules are considerably more involved than
...
Where a patch set proposes to change the ESCO consensus, it must have been
...
The project leader is the release manager for each ESCO Core release.
