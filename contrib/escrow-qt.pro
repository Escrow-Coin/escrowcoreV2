...
RESOURCES += src/qt/escrow.qrc src/qt/escrow_locale.qrc

TRANSLATIONS += src/qt/locale/escrow_bg.ts \
                src/qt/locale/escrow_de.ts \
                src/qt/locale/escrow_en.ts \
                src/qt/locale/escrow_es.ts \
                src/qt/locale/escrow_fi.ts \
                src/qt/locale/escrow_fr.ts \
                src/qt/locale/escrow_it.ts \
                src/qt/locale/escrow_ja.ts \
                src/qt/locale/escrow_pl.ts \
                src/qt/locale/escrow_pt.ts \
                src/qt/locale/escrow_ru.ts \
                src/qt/locale/escrow_sk.ts \
                src/qt/locale/escrow_sv.ts \
                src/qt/locale/escrow_vi.ts \
                src/qt/locale/escrow_zh_CN.ts \
                src/qt/locale/escrow_zh_TW.ts
