...
Setup
---------
Configuring the github-merge tool for the ESCO repository is done in the following way:

    git config githubmerge.repository Escrow-Coin/Escrow
...
A script to optimize png files in the ESCO
