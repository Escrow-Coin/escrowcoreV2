...
// Copyright (c) 2015-2017 The ESCO developers
...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("ESCO Core");
    ...
    QString copyrightTextESCO = QChar(0xA9) + QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The ESCO Core developers"));
