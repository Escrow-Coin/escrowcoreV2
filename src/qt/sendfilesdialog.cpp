...
void SendFilesDialog::on_sendFileToAddressButton_clicked()
{
    ...
    foreach (const SendCoinsRecipient &rcp, recipients) {
        ...
        formatted.append(tr("File price") + ": " + BitcoinUnits::formatHtmlWithUnit(BitcoinUnits::ESCO, ui->priceField->value()) + "<br />");
    }
...
// TODO: ESCO2 fix problem with resizing
...
void SendFilesDialog::on_tablePaymentRequests_doubleClicked(const QModelIndex &index) {
    ...
    if (!paymentAddress.IsValid()) {
        QMessageBox::critical(this, tr("Send File"), tr("Invalid ESCO address"), QMessageBox::Ok, QMessageBox::Ok);
        return;
    }
    ...
    wtx.meta = CPaymentConfirm(paymentRequestWtx.GetHash(), nStorageDays * 24 * 60 * 60, publicKey); // TODO: ESCO 2 change lifetime
    ...
    recipient.amount = nAmount; // TODO: ESCO1 ?
    recipient.useSwiftTX = false;
    ...
    infoElement.append(tr("File price") + ": " + BitcoinUnits::formatHtmlWithUnit(BitcoinUnits::ESCO, paymentRequest->nPrice) + "<br />");
