...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a ESCO address (e.g. %1)").arg("EfuPJJ2GgYqCDoRJTH72QiF7coBGgSB3B9"));
#endif
...
{
    // return if URI is not valid or is no ESCO: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ESCO.lnk";
}
