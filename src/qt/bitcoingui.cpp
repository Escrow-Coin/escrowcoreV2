                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ESCO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ESCO address"));
    ...
    sendFilesAction->setStatusTip(tr("Send file to a ESCO address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ESCO Core"), this);
    aboutAction->setStatusTip(tr("Show information about ESCO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ESCO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ESCO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ESCO addresses"));
    ...
    openAction->setStatusTip(tr("Open a ESCO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ESCO Core help message to get a list with possible ESCO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ESCO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ESCO network", "", count));
}
...
{
    QString strTitle = tr("ESCO Core"); // default title
