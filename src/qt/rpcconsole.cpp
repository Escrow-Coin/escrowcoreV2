                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPIVPathCustom = GetArg("-zescrowbackuppath", "");
    ...
    if(!strzPIVPathCustom.empty()) {
        ui->wallet_customzescrowbackuppath->setText(QString::fromStdString(strzPIVPathCustom));
        ui->wallet_customzescrowbackuppath_label->setVisible(true);
        ui->wallet_customzescrowbackuppath->setVisible(true);
    }
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ESCO RPC console.") + "<br>" +
