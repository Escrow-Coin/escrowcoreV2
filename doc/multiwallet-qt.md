...
In order to support loading of multiple wallets in escrow-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is escrow.cpp.
...
Changes to escrow.cpp
----------------------
escrow.cpp is the entry point into escrow-qt, and as such, will require some minor modifications to provide hooks for
