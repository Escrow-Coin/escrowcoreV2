...
*Setup instructions for a gitian build of ESCO using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the ESCO
...
To build ESCO (for Linux, OSX and Windows) just follow the steps under 'perform
